...
namespace RMS.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260504022455_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RMS.Domain.Entities.Models.AcademicDegree", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("RMS.Domain.Entities.Models.ApplicationFile", b =>
                {
            ...
            modelBuilder.Entity("RMS.Domain.Entities.Models.File", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("RMS.Domain.Entities.Models.ResearchHour", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("RMS.Domain.Entities.Models.StepDetail", b =>
                {
                    ...
                    b.Property<Guid?>("NextStepDetailId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("NextStepDetailId");

                    b.HasIndex("StepId");

                    b.ToTable("StepDetails");
                });
            ...
            modelBuilder.Entity("RMS.Infrastructure.Identity.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("RMS.Infrastructure.Identity.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("RMS.Domain.Entities.Models.ApplicationFile", b =>
                {
                    b.HasOne("RMS.Domain.Entities.Models.Application", "Application")
                        .WithMany("ApplicationFiles")
                        .HasForeignKey("ApplicationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("RMS.Domain.Entities.Models.File", "File")
                        .WithMany("ApplicationFiles")
            ...
            modelBuilder.Entity("RMS.Domain.Entities.Models.StepDetail", b =>
                {
                    b.HasOne("RMS.Domain.Entities.Models.StepDetail", "NextStepDetail")
                        .WithMany()
                        .HasForeignKey("NextStepDetailId")
                        .OnDelete(DeleteBehavior.Restrict);
