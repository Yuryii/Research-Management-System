    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ResearchHours", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Order = table.Column<int>(type: "int", nullable: false),
                    StepId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    NextStepDetailId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    Created = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    LastModified = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    LastModifiedBy = table.Column<string>(type: "nvarchar(max)", nullable: true)
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StepDetails_StepDetails_NextStepDetailId",
                        column: x => x.NextStepDetailId,
                        principalTable: "StepDetails",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_StepDetails_Steps_StepId",
                        column: x => x.StepId,
                        principalTable: "Steps",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Applications_StepDetails_StepDetailId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ApplicationFiles", x => new { x.ApplicationId, x.FileId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ApplicationFiles_Files_FileId",
                        column: x => x.FileId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApplicationFiles_FileId",
                table: "ApplicationFiles",
                column: "FileId");

            migrationBuilder.CreateIndex(
                name: "IX_Applications_StepDetailId",
                table: "Applications",
                column: "StepDetailId");
            ...
            migrationBuilder.CreateIndex(
                ...
                table: "StepDetails",
                column: "NextStepDetailId");

            migrationBuilder.CreateIndex(
                name: "IX_StepDetails_StepId",
                table: "StepDetails",
                column: "StepId");
